...
- Criar infra/local/ com:
  - docker-compose.yml (serviços: localstack)
...
- Criar web/ com:
  ...
  - sso.js (1 - SSO real acessando a microsoft para login. 2 - tudo que obter da credencial, colocar os dados na página para visualização. 3 - armazenar dados em local storage)
